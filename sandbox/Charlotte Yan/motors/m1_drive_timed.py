...
#     300 degrees / second  -->  traveled 35.0 inches  -->  3.50 inches / second
#     400 degrees / second  -->  traveled 45.125 inches  -->  4.51 inches / second
#   Tests @ 5 seconds:
#     500 degrees / second  -->  traveled 28.0 inches  -->  5.6 inches / second
#     600 degrees / second  -->  traveled 33.5 inches  -->  6.7 inches / second
#     700 degrees / second  -->  traveled 40.875 inches  -->  8.2 inches / second
#     800 degrees / second  -->  traveled 44.75 inches  -->  9.0 inches / second
#     900 degrees / second  -->  traveled 48.0 inches  -->  9.6 inches / second (probably no faster than 800)
#
...
def main():
    ...
    while time_s != 0:
        ...
        if sp == 0 or distance == 0:
            break
        speed_in_inches_per_second = 0.012 * sp
        time_s = int(distance/speed_in_inches_per_second)
