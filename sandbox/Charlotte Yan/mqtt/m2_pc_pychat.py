...
def main():
    ...
    my_name = "Charlotte Yan"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Simon Kim"  # Used to set the topic that you will *publish to*
