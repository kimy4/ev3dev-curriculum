...
Much like we did in kimy4 of the motors unit, later we will show you different (better) ways to use buttons.
...
def main():
    ...
    while True:
        ...
        #   The first press to down should make bo/th LEDs GREEN, the next press makes them RED, then AMBER, then off.
        ...
        if btn.down:
            while True:
                ev3.Leds.set_color(ev3.Leds.LEFT, led_colors[current_color_index%4])
                ev3.Leds.set_color(ev3.Leds.RIGHT, led_colors[current_color_index%4])
