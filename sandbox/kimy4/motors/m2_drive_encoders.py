...
def main():
    ...
    while time_s != 0:
        ...
        left_motor.run_to_rel_pos(motor_turns_needed_in_degrees, speed_in_inches_per_second, ev3.Sound.beep().wait_while())
        right_motor.run_to_rel_pos(motor_turns_needed_in_degrees, speed_in_inches_per_second, ev3.Sound.beep().wait_while())
        ev3.Sound.beep().wait()
